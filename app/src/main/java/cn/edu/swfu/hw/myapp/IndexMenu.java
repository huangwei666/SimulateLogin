...
public class IndexMenu extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            URL url = null;
            try {
                url = new URL("http://202.203.132.204:8019/(c5itei55ffluveaafibfulev)/xscjcx.aspx?xh="+xh+"&xm=(unable to decode value)&gnmkdm=N121605");
            ...
            call.enqueue(new Callback() {
                ...
                public void onResponse(Call call, final Response response) throws IOException {
                    ...
                    Intent intentcj = new Intent();
                    intentcj.putExtra("cjhtml",string);
                    intentcj.setClass(IndexMenu.this,selectscoreinfo.class);
